...
//@ViewScoped
@ManagedBean(name = "consulterComptageAeController")
@ViewScoped
public class ConsulterComptageAeController implements Serializable {
...
//    private Boolean validation;
    ...
    private String modePhaseString;
...
//    private ReleveFacadeLocal releveFacadeLocal;
    ...
    // les Methodes : 
    //init:
    public ConsulterComptageAeController() {
    }
    ...
    public void initialiserController() {
        if (Util.getsession("session") == null) {
            ...
            String id = getRequestParameter("selectedComptageAeid");


            comptageAe = comptageAeFacadeLocal.find(Long.parseLong(id));   
            
            if(comptageAe.getModePhase()==1)
                modePhaseString = "Mono phase";
            else
                modePhaseString = "Tri phase";
            
            pdlAe = pdlAeFacadeLocal.find(comptageAe.getPdlAeid().getId());
            marque = marqueFacadeLocal.find(comptageAe.getMarqueid().getId());
            nature = natureFacadeLocal.find(comptageAe.getNatureid().getId());
        }
    ...
    public String getModePhaseString() {
        return modePhaseString;
    }

    public void setModePhaseString(String modePhaseString) {
        this.modePhaseString = modePhaseString;
    }
